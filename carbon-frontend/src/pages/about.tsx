...
import Head from "next/head"; // 1. IMPORT Head DITAMBAHKAN
...
export default function AboutPage() {
  return (
    <>
      {/* 2. BLOK HEAD DITAMBAHKAN DI SINI UNTUK MENGATUR TAB BROWSER */}
      <Head>
        <title>ITB Carbon Emissions Visualization</title>
        <meta name="description" content="About the ITB Carbon Emissions Visualization project" />
